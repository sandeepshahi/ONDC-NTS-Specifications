let build_spec = {
  ...
  info: {
    ...
    description:
      "ONDC  Reconciliation and Settlement Framework API Specification",
    version: "2.0.0",
  },
                            ...
                            settlements: {
                              ...
                              items: {
                                ...
                                properties: {
                                  ...
                                  tcs: { $ref: "#/components/schemas/Amount" },
                                  tds: { $ref: "#/components/schemas/Amount" },
                                  updated_at: {
                                    type: "string",
                                    format: "date-time",
                                  },
  ...
  components: {
    ...
    schemas: {
      ...
      BankDetails: {
        type: "object",
        properties: {
          account_no: { type: "string", example: "" },
          ifsc_code: { type: "string", example: "" },
        },
      },
      Context: {
        ...
        properties: {
          ...
          location: {
            ...
            properties: {
              country: {
                type: "object",
                properties: { code: { type: "string", example: "IND" } },
              },
              city: {
                type: "object",
                properties: { code: { type: "string", example: "*" } },
              },
            },
          },
          action: {
      ...
      Error: {
        description:
          "Describes an error object that is returned by a Collector or Receiver as a response or callback to an action by another network participant. This object is sent when any request received by a network participant is unacceptable. This object can be sent either during Ack or with the callback.",
        type: "object",
        properties: {
          code: {
            type: "string",
            description:
              "Standard error code. For full list of error codes, refer <a href = https://ondc-official.github.io/ONDC-NTS-Specifications/#error>here</a>",
          },
          message: {
            type: "string",
            description:
      ...
      Orders: {
        ...
        items: {
          type: "object",
          properties: {
            id: { description: "Describes the order id", type: "string" },
            inter_participant: {
              description:
                "Provides details about the settlement amount, payable/ receivable and status between the Collector and the Receiver",
              type: "object",
              properties: {
                settled_amount: { $ref: "#/components/schemas/Amount" },
                amount: { $ref: "#/components/schemas/Amount" },
            ...
            collector: {
              description:
                "Provides details about the amount to be retained by the collector",
              type: "object",
              properties: { amount: { $ref: "#/components/schemas/Amount" } },
            },
            provider: {
              description:
                "Provides details about the amount to be settled to the Provider of an NP.",
              type: "object",
              properties: {
            ...
            self: {
              type: "object",
              description:
                "Provides details about the amount for the NP to move to their operative account",
              properties: {
                amount: { $ref: "#/components/schemas/Amount" },
                status: { type: "string", enum: ["SETTLED", "NOT_SETTLED"] },
                reference_no: { type: "string" },
      ...
      Settlement: {
        description:
          "- Describes the settlement of NP -NP - Describes the miscellaneous settlement - Describes the NIL settlement\n",
        type: "object",
        properties: {
          type: {
          ...
          id: {
            description: "* settlement id of the settlement file\n",
            type: "string",
          },
          order: { $ref: "#/components/schemas/Orders" },
        },
      },
    },
  },
    ...
    settle: {
      context: {
        location: {
          ...
          city: { code: [{ code: "*", description: "city" }] },
        },
        domain: [{ code: "ONDC:NTS10", description: "RSF" }],
      },
      message: {
        settlement: {
          type: [
            { code: "NP-NP", description: "Interparticipant settlement" },
            { code: "MISC", description: "Miscellaneous" },
            { code: "NIL", description: "NP Declaring no settlement required" },
          ],
        },
      },
    },
      ...
      message: {
        settlement: {
          ...
          orders: {
            inter_participant: {
              status: [
                { code: "SETTLED", description: "settlement successful" },
                { code: "NOT_SETTLED", description: "settlement unsuccessful" },
              ],
            },
            provider: {
              status: [
    ...
    recon: {
      ...
      message: {
        orders: {
          settlements: {
            status: [
              { code: "SETTLED", description: "Successfully settled" },
              {
                code: "PENDING",
                description:
                  "Settlement awaited due to reconciliation difference between NPs",
              },
              {
                code: "TO_BE_INITIATED",
                description:
                  "Settlement to be initiated in a future settlement cycle",
              },
            ],
          },
        },
  ...
  "x-flows": [
    {
      ...
      details: [
        {
          description:
            "Detailed flows covering NPs seeking status of a settlement instructions previously shared with reference to a transaction id and/ or message id. The settlement agency responds with the status of the respective settlement instructions referred.",
          mermaid:
      ...
      steps: [
        ...
        },
        {
          ...
          details: [
            {
              description:
                "Response from settlement agency (including provider details)",
              mermaid:
                  ...
                  orders: [
                    {
                      id: "order-id-456",
                      inter_participant: {
                        settled_amount: { currency: "INR", value: "1000.00" },
                        amount: { currency: "INR", value: "1000.27" },
                        status: "SETTLED",
                      ...
                      provider: {
                        ...
                        status: "NOT_SETTLED",
                        error: { code: "01", message: "Account Inactive" },
                      },
                      self: {
                        amount: { currency: "INR", value: "200.00" },
                        status: "NOT_SETTLED",
                        error: { code: "01", message: "Account Inactive" },
                      },
                    },
        ...
        },
        {
          ...
          details: [
            {
              description:
                "Response from settlement agency (if no provider is specified)",
              mermaid:
                "sequenceDiagram\n participant NP\n participant Settlement_Agency\n NP ->> Settlement_Agency: report API  \n Settlement_Agency ->> NP : Ack\n Settlement_Agency ->> NP : on_ report API\n NP ->> Settlement_Agency : Ack",
            },
          ],
      ...
      steps: [
        {
          ...
          details: [
            {
              description:
                "Reconciliation call to understand the discrepancy in the settlement instructions",
              mermaid:
            ...
            value: {
              ...
              message: {
                orders: [
                  {
                    id: "order-1234",
                    amount: { currency: "INR", value: "300.00" },
                    settlements: [
                      {
                        ...
                        tcs: { currency: "INR", value: "10.00" },
                        tds: { currency: "INR", value: "10.00" },
        ...
        },
        {
          ...
          details: [
            {
              description:
                "Response to the reconciliation call, expressing disagreement with the information provided in /recon",
              mermaid:
                "sequenceDiagram\n participant Collector\n participant Receiver\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API",
            },
          ],
        ...
        },
        {
          ...
          details: [
            {
              description:
                "Reconciliation call with the updated information, agreeing to the information provided by the counterparty in /on_recon",
              mermaid:
                "sequenceDiagram\n participant Collector\n participant Receiver\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API",
            },
          ],
          ...
          example: {
            value: {
              context: {
                ...
                bpp_uri: "https://receiver-app.com/ondc/",
                transaction_id: "bd73a366-aebb-4144-9314-808dda82c7e6",
                message_id: "990ef6d7-d74d-4411-ac06-a05469c0f9ac",
                timestamp: "2024-05-07T06:36:52.897Z",
                ttl: "P1D",
              },
              message: {
                orders: [
        ...
        },
        {
          ...
          details: [
            {
              description:
                "Response to the reconciliation call,  agreeing with the information provided in /recon",
              mermaid:
                "sequenceDiagram\n participant Collector\n participant Receiver\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API\n Collector ->> Receiver : /recon API\n Receiver ->> Collector: /on_recon API",
            },
          ],
          ...
          example: {
            value: {
              context: {
                ...
                transaction_id: "bd73a366-aebb-4144-9314-808dda82c7e6",
                message_id: "990ef6d7-d74d-4411-ac06-a05469c0f9ac",
                timestamp: "2024-05-07T06:36:53.897Z",
                ttl: "P1D",
              },
              message: {
                orders: [
                    ...
                    settlements: [
                      {
                        ...
                        tcs: { currency: "INR", value: "10.00" },
                        tds: { currency: "INR", value: "10.00" },
                        updated_at: "2024-05-07T07:36:53.897Z",
                      },
                      {
                        id: "settlement-id-789",
                        payment_id: "pymnt-2",
                      ...
                      },
                      {
                        ...
                        tds: { currency: "INR", value: "10.00" },
                        tcs: { currency: "INR", value: "10.00" },
                        updated_at: "2024-05-07T06:36:53.897Z",
                      },
                    ],
                  },
                ],
        ...
        },
        {
          ...
          example: {
            value: {
              ...
              error: { code: "70030", message: "Invalid Order Id" },
            },
          },
        },
      ],
        ...
        report: {
          context: {
            domain: {
              ...
              owner: "any",
              usage: "ONDC:NTS10",
              description: "Domain in which the settlement occurs",
            },
            location: {
              country: {
                code: {
                  ...
                  usage: "IND",
                  description:
                    "Describes country code as per ISO 3166-1 and ISO 3166-2 format",
                },
              },
              city: {
                code: {
            ...
            version: {
              ...
              usage: "2.0.0",
              description:
                "Describes the version of transaction protocol being used by the sender.",
            },
            action: {
              required: true,
              type: "string",
              ...
              usage: "report",
              description:
                "Describes the method being called by the sender and executed at the receiver.",
            },
            bap_id: {
              required: true,
              type: "string",
              ...
              description: "Describes the subscriber id of the BNP",
            },
            bap_uri: {
              required: true,
              type: "string",
              ...
              description: "Describes the subscriber uri of the BNP",
            },
            bpp_id: {
              required: true,
              type: "string",
              ...
              description: "Describes the subscriber id of the SNP",
            },
            bpp_uri: {
              required: true,
              type: "string",
              ...
              description: "Describes the subscriber uri of the SNP",
            },
            transaction_id: {
              required: true,
              type: "string",
              ...
              description:
                "Describes  a unique value which persists across all API calls",
            },
            message_id: {
              required: true,
              type: "string",
              ...
              description:
                "Describes a unique value which persists during a request / callback cycle.",
            },
            timestamp: {
              required: true,
              type: "string",
              ...
              description:
                "Describes time of request generation in RFC3339 format",
            },
            ttl: {
              required: true,
              type: "string",
              ...
              usage: "P1D",
              description:
                "Describes the duration in ISO8601 format after timestamp for which this message holds valid",
            },
          },
          message: {
            collector_app_id: {
              ...
              owner: "any",
              usage: "collectorapp.com",
              description: "Subscriber Id of Collecter ",
            },
            receiver_app_id: {
              required: true,
              type: "string",
              ...
              description: "Subscriber Id of Reciever",
            },
            settlement: {
              type: {
                required: true,
              ...
              orders: {
                self: {
                  amount: {
                    currency: {
                      ...
                      usage: "INR",
                      description:
                        "Currency of the amount that is to be moved to the API caller's operating account",
                    },
                    value: {
                      required: true,
                      type: "string",
                      ...
                      usage: "200.00",
                      description:
                        "Self amount is the amount that is to be moved to the API caller's operating account",
                    },
                  },
                  status: {
                    required: true,
                    ...
                    owner: "any",
                    usage: "NOT_SETTLED",
                    description: "Status of self fund settlement",
                  },
                  reference_no: {
                    ...
                    usage: "1238683618634",
                    description:
                      "Reference number of self fund settlement if status is NOT_SETTLED not required if settlement is not settled",
                  },
                  error: {
                    code: {
                      required: "Conditional",
                      ...
                      usage: "01",
                      description:
                        "Code of the error occurred at the time of settlement",
                    },
                    message: {
                      required: "Conditional",
                      type: "string",
                ...
                provider: {
                  id: {
                    ...
                    usage: "prvdr-id-789",
                    description:
                      "The provider ID must be provided if settlement is being made to the provider",
                  },
                  name: {
                    required: "optional",
                    type: "string",
                    ...
                    description:
                      "The Name of the provider must be provided if settlement is being made to the provider",
                  },
                  bank_details: {
                    account_no: {
                      required: "Conditional",
                      ...
                      usage: "1234567890",
                      description:
                        "The Account number of the provider must be provided if settlement is being made to the provider",
                    },
                    ifsc_code: {
                      required: "Conditional",
                      type: "string",
                      ...
                      usage: "IFSC0001",
                      description:
                        "IFSC code of the provider must be provided if settlement is being made to the provider",
                    },
                  },
                  amount: {
                    currency: {
                      ...
                      usage: "INR",
                      description:
                        "Currency of the amount that is to be transferred to the provider's provided account must be provided if settlement is being made to the provider",
                    },
                    value: {
                      required: "Conditional",
                      type: "string",
                      ...
                      usage: "800.00",
                      description:
                        "Provider amount is the amount that is to be transferred to the provider's provided account must be provided if settlement is being made to the provider",
                    },
                  },
                  status: {
                    required: "Conditional",
                    ...
                    usage: "NOT_SETTLED",
                    description:
                      "Status of provider fund settlement must be provided if settlement is being made to the provider",
                  },
                  reference_no: {
                    required: "Conditional",
                    type: "string",
                    ...
                    usage: "3718683618631",
                    description:
                      "Reference number of provider fund settlement if amount is SETTLED",
                  },
                  error: {
                    code: {
                      required: "Conditional",
                      ...
                      usage: "01",
                      description:
                        "Code of the error occurred at the time of settlement if settlement is not settled",
                    },
                    message: {
                      required: "Conditional",
                      type: "string",
                      ...
                      usage: "Account inactive",
                      description:
                        "Message of the error occurred at the time of settlement if settlement is not settled",
                    },
                  },
                },
                id: {
                ...
                inter_participant: {
                  amount: {
                    currency: {
                      ...
                      usage: "INR",
                      description:
                        "Currency of the amount that is to be settled from collector to receiver",
                    },
                    value: {
                      required: true,
                      type: "string",
                      ...
                      usage: "1000.00",
                      description:
                        "Inter participant amount is what is to be settled from collector to receiver",
                    },
                  },
                  status: {
                    required: true,
                    ...
                    owner: "any",
                    usage: "SETTLED",
                    description: "Status of interparticipant fund settlement",
                  },
                  reference_no: {
                    required: "Conditional",
                    type: "string",
                    ...
                    usage: "3718683618631",
                    description:
                      "Reference number of Interparticipant fund settlement not required if settlement is not settled",
                  },
                  error: {
                    code: {
                      required: "Conditional",
                ...
                collector: {
                  amount: {
                    currency: {
                      ...
                      usage: "INR",
                      description:
                        "Currency of the amount that the collector keeps for themselves",
                    },
                    value: {
                      required: true,
                      type: "string",
            ...
            ref_transaction_id: {
              ...
              description:
                "Reference transaction ID of the settlement instruction",
            },
            ref_message_id: {
              required: true,
              type: "string",
              ...
              description: "Reference message ID of the settlement instruction",
            },
          },
        },
        on_report: {
          ...
          message: {
            ...
            settlement: {
              type: {
                ...
                owner: "any",
                usage: "NP-NP",
                description: "Type of Interparticipant Settlement",
              },
              id: {
                required: true,
                type: "string",
                ...
                description: "Id of Interpartcipant settlement",
              },
              orders: {
                self: {
                  amount: {
                  ...
                  reference_no: {
                    ...
                    usage: "3718683618631",
                    description:
                      "Reference number of self fund settlement not required if settlement is not settled",
                  },
                  error: {
                    code: {
                      required: "Conditional",
                ...
                provider: {
                  ...
                  status: {
                    ...
                    owner: "any",
                    usage: "NOT_SETTLED",
                    description: "Status of provider fund settlement",
                  },
                  reference_no: {
                    required: "Conditional",
                    type: "string",
                    ...
                    usage: "3718683618631",
                    description:
                      "Reference number of provider fund settlement if settlement is Settled",
                  },
                  error: {
                    code: {
                      required: "Conditional",
            ...
            orders: {
              amount: {
                currency: {
                  ...
                  owner: "any",
                  usage: "INR",
                  description: "Currency of the amount of the Order",
                },
                value: {
                  required: true,
                  type: "string",
                  owner: "any",
                  usage: "300.00",
                  description: "Value of the amount of the Order",
                },
              },
              id: {
                required: true,
              ...
              settlements: {
                amount: {
                  currency: {
                    ...
                    owner: "any",
                    usage: "INR",
                    description: "Currency of the amount of the settlement",
                  },
                  value: {
                    required: true,
                    type: "string",
                    owner: "any",
                    usage: "300.00",
                    description: "Value of the amount of the settlement",
                  },
                },
                commission: {
                  currency: {
                    ...
                    owner: "any",
                    usage: "INR",
                    description: "Currency of the commission on the order",
                  },
                  value: {
                    required: true,
                    type: "string",
                    owner: "any",
                    usage: "300.00",
                    description: "Value of the commission on the order",
                  },
                },
                id: {
                  required: true,
                ...
                payment_id: {
                  ...
                  owner: "any",
                  usage: "pymnt-1",
                  description: "Payment ID of the settlement",
                },
                settlement_ref_no: {
                  required: "Conditional",
                  type: "string",
                  ...
                  usage: "utr-1234",
                  description:
                    "Settlement Reference number of the settlement is required if settlement is settled",
                },
                status: {
                  required: true,
                  type: "string",
                ...
                tcs: {
                  currency: {
                    ...
                    owner: "any",
                    usage: "INR",
                    description: "Currency of tax collected at source",
                  },
                  value: {
                    required: true,
                    type: "string",
                    owner: "any",
                    usage: "300.00",
                    description: "Value of tax collected at source",
                  },
                },
                tds: {
                  currency: {
                    ...
                    owner: "any",
                    usage: "INR",
                    description: "Currency of tax deducted at source",
                  },
                  value: {
                    required: true,
                    type: "string",
                    owner: "any",
                    usage: "300.00",
                    description: "Value of tax deducted at source",
                  },
                },
                updated_at: {
                  required: true,
                  ...
                  owner: "any",
                  usage: "2024-05-09T06:36:51.897Z",
                  description: "Settlement modification time",
                },
                withholding_amount: {
                  currency: {
                    required: true,
                    ...
                    owner: "any",
                    usage: "INR",
                    description: "Currency of the withholding amount",
                  },
                  value: {
                    required: true,
                    type: "string",
                    owner: "any",
                    usage: "300.00",
                    description: "Value of the withholding amount",
                  },
                },
              },
            },
          ...
          message: {
            orders: {
              ...
              recon_accord: {
                ...
                owner: "any",
                usage: true,
                description: "Formal agreement of the settled amount",
              },
              settlements: {
                amount: {
                  currency: {
                  ...
                  diff_amount: {
                    ...
                    usage: "300.00",
                    description:
                      "Difference in the settlement amount incase recon_accord is FALSE",
                  },
                  value: {
                    required: true,
                    type: "string",
                ...
                commission: {
                  ...
                  diff_amount: {
                    ...
                    usage: "300.00",
                    description:
                      "Difference in the commission amount incase recon_accord is FALSE",
                  },
                  value: {
                    required: true,
                    type: "string",
                ...
                payment_id: {
                  ...
                  owner: "any",
                  usage: "utr-1234",
                  description: "Payment_Id of the settlement",
                },
                settlement_ref_no: {
                  required: "Conditional",
                  type: "string",
                ...
                due_date: {
                  ...
                  usage: "2024-05-09",
                  description:
                    "due date of settlement in case recon_accord is true",
                },
                status: {
                  required: true,
                  type: "string",
                ...
                tcs: {
                  ...
                  diff_amount: {
                    ...
                    usage: "300.00",
                    description:
                      "Difference in the tax collected at the source incase recon_accord is FALSE",
                  },
                  value: {
                    required: true,
                    type: "string",
                ...
                tds: {
                  ...
                  diff_amount: {
                    ...
                    usage: "300.00",
                    description:
                      "Difference in the tax deducted at the source incase recon_accord is FALSE",
                  },
                  value: {
                    required: true,
                    type: "string",
                ...
                withholding_amount: {
                  ...
                  diff_amount: {
                    ...
                    usage: "300.00",
                    description:
                      "Difference in the withholding amount incase recon_accord is FALSE",
                  },
                  value: {
                    required: false,
                    type: false,
  ...
  "x-featureui": { filenames: ["Technical Salient Features.md"] },
  "x-sandboxui": {
    dropdown: [
      {
        "environment-name": "staging",
        link: "https://rsf-mock-service.ondc.org/mock_ui",
      },
    ],
  },
  "x-changeLog": { filenames: ["NTS10_2.0.0_301224.md"] },
};
